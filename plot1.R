...
png(filename = "plot0.png", width = 480, height = 480, units = "px", bg = "transparent")
hist(housholdDT2$Global_active_power, main = "Global Active Power", xlab = "Global Active Power (kilowatts)", col = "red")
dev.off() 